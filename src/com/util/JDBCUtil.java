...
public class JDBCUtil {
    ...
    public static String URL = "jdbc:mysql://localhost:3306/shoppingdb?userUnicode=true&characterEncoding=utf-8";
     ...
     * 增删改返回执行成功记录数
     */
    public static int excuteUpdates(String sql, int[] o){
        int result = 0;
        Connection con = getconnnection();
        PreparedStatement ps = null;
        try {
